...
public class Battle {
    ...
    public void resolveTurn(Pokemon pokemonPlayer1, Pokemon pokemonPlayer2, int move1, int move2) {
        // Both want To change
        ...
        if(!(slowMove==-1)) {
            ...
            double damage = calculateDamage(slowerPokemon, fasterPokemon, move);
